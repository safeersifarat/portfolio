          ...
          {isPhone ? (
            <>
              <div className="flex justify-center items-center mb-4">
                <div
                  className="relative h-32 w-28 scale-x-350 -translate-y-5 md:translate-y-0 md:scale-x-100 profile-blob border-[2px] border-cyan-100 flex items-center justify-center bg-linear-to-br from-cyan-700 to-blue-600/40"
                  style={{
                    boxShadow: `
